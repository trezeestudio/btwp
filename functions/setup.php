...
function bst_setup()
{
	...
	update_option('xs', 200);
	update_option('sm', 600);
}
...
{
	return '&nbsp; <a href="' . get_permalink() . '">' . '&hellip; ' . __('Continuar leyendo', 'bst') . ' <i class="glyphicon glyphicon-arrow-right"></i>' . '</a></p>';
}
...
if (!function_exists('bst_pagination'))
{
	...
	function bst_pagination()
	{
		...
		$paginate_links = paginate_links(array(
				...
				'mid_size' => 5, 
				'prev_next' => True, 
				'prev_text' => __('<i class="glyphicon glyphicon-chevron-left"></i> Nuevo'), 
				'next_text' => __('Anterior <i class="glyphicon glyphicon-chevron-right"></i>'), 
				'type' => 'list'));
